...
export function SkeletonLine({ className }: { className?: string }) {
  return (
    <div className={cn('animate-pulse bg-gray-200 rounded h-4', className)} />
  )
}

export function SkeletonCard() {
  return (
    <div className="p-6 border border-gray-200 rounded-lg shadow-sm animate-pulse">
      <div className="flex space-x-4">
        <div className="rounded-md bg-gray-200 h-12 w-12" />
