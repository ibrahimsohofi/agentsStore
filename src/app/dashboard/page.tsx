                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="pt-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Download Rate</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-600">From marketplace views</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-600">Post-purchase downloads</p>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {analytics.topAgents.map((agent) => (
                    <div key={agent.id} className="border rounded-lg p-6 hover:bg-gray-50">
