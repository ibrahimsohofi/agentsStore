                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    {(!dashboardData?.pendingAgents || dashboardData.pendingAgents.length === 0) && (
                      <p className="text-center text-gray-500 py-4">No pending agent reviews</p>
                    )}
                  </div>
                </CardContent>
              </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="border rounded-lg">
                  ...
                  <div className="p-4">
                    <p className="text-center text-gray-500">Agent moderation interface coming soon...</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="border rounded-lg">
                  ...
                  <div className="p-4">
                    <p className="text-center text-gray-500">Order management interface coming soon...</p>
                  </div>
                </div>
              </CardContent>
            </Card>
