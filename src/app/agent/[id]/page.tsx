    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
          <Link href="/marketplace" className="hover:text-gray-700 flex items-center">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">Import the n8n workflow file into your workspace</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">Add your OpenAI API key and webhook endpoints</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">Run a test to ensure everything is working correctly</p>
                        </div>
                      </div>
                    </div>
