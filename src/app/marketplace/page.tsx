...
export default function Marketplace() {
  ...
  const AgentCard = ({ agent, featured = false }: { agent: typeof mockAgentsData[0], featured?: boolean }) => (
    <Card className={`hover:shadow-lg transition-all duration-200 cursor-pointer group ${featured ? 'ring-2 ring-blue-200' : ''}`}>
      ...
      <CardContent>
        ...
        <div className="flex justify-between items-center gap-2">
          <p className="text-sm text-gray-500">by {agent.seller.name}</p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">Discover intelligent automation solutions for your business</p>
        </div>
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            {selectedCategory === "all" && (
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Featured Agents</h3>
